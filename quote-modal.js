...
(() => {
  const SUPABASE_URL = "https://wapmphhazgszdzruyqge.supabase.co";
  const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndhcG1waGhhemdzemR6cnV5cWdlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg4NDYxOTcsImV4cCI6MjA4NDQyMjE5N30.lDB3QRnPUsNlsjUCV3_om-y-piB7Vfm71kYx-yKfYaM";
  ...
  async function submitToSupabase(form) {
    ...
    const company = normalizeOptional((form.elements.company || form.elements.empresa)?.value);
    ...
    try {
      ...
      if (statusEl) {
        ...
        statusEl.textContent = "Gracias - recibimos tu solicitud. Te contactaremos pronto.";
      }
      form.reset();
      ...
      if (statusEl) {
        ...
        statusEl.textContent = "Lo sentimos - hubo un error al enviar tu solicitud. Intenta de nuevo.";
      }
